...
COHORTS_CSV = (
    Path(__file__).parents[4] / "DATA" / "DELCODE" / "__metadata__" / "cohorts_with_scans.csv"
)
DOWNSTREAM_SPLITS_DIR = (
    Path(__file__).parents[4] / "DATA" / "DELCODE" / "__metadata__" / "SPLITS" / "downstream"
)
