...
COHORTS_CSV = _REPO_ROOT / "DATA" / "DELCODE" / "__metadata__" / "cohorts_with_scans.csv"
DOWNSTREAM_SPLITS_DIR = _REPO_ROOT / "DATA" / "DELCODE" / "__metadata__" / "SPLITS" / "downstream"
OUTPUT_DIR = _REPO_ROOT / "DATA" / "DELCODE" / "__metadata__" / "SPLITS" / "pretrain"
