...
def train_vgae_with_val(
    ...
    *, beta=1.0, beta_warmup_epochs=0, epochs=100, early_stopping_patience=25, wandb_run=None,
):
    ...
    for epoch in outer_bar:
        ...
        tr_loss, tr_recon, tr_kl = _run_epoch(model, train_loader, optimizer, device, current_beta, train=True)
        va_loss, _va_recon, _va_kl = _run_epoch(model, val_loader, optimizer, device, current_beta, train=False)
